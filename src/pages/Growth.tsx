...
import { BookOpen, Flame, Award, Calendar, CheckCircle2 } from 'lucide-react';
...
export function Growth() {
  ...
  const markReadToday = () => {
    ...
    if (data.completedDays.includes(today)) return; // Already read today
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-4xl">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-white  p-6 rounded-2xl shadow-sm border border-church-earth/5  flex flex-col items-center text-center transition-all hover:shadow-md">
            ...
            <h3 className="text-xl font-bold text-church-earth-dark  mb-1">Faithful</h3>
        ...
        <div className="bg-white  rounded-3xl shadow-sm border border-church-earth/5  overflow-hidden">
          <div className="p-8 md:p-12">
            ...
            <div className="prose prose-lg text-church-earth  max-w-none mb-8">
              <h3 className="text-xl font-bold text-church-earth-dark ">Psalm 23</h3>
            ...
            <div className="flex justify-center border-t border-church-earth/10  pt-8">
              {hasReadToday ? (
                ...
                <button 
                  ...
                  className="bg-church-gold hover:bg-church-gold-dark text-white px-8 py-4 rounded-xl font-medium transition-all hover:shadow-md hover:-translate-y-0.5 flex items-center gap-2 text-lg"
                >
                  <CheckCircle2 className="w-6 h-6" />
                  Mark as Read
                </button>
